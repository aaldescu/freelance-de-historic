...
projects_df['date'] = pd.to_datetime(projects_df['date'], errors='coerce').dt.floor('D')
freelancers_df['date'] = pd.to_datetime(freelancers_df['date'],errors='coerce').dt.floor('D')
